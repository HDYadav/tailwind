    ...
    <div class="flex items-center justify-between">
      ...
      <div class="flex items-center">
          <div class="flex items-center ms-3">
                 ...
                 <div class="p-1 px-3 border-e-2 ">
                     <i class="bi bi-gear text-lg"></i>
                 </div>
          
                <div class="p-1 px-3 border-e-2">
                        <button id="dropdownNotificationButton" data-dropdown-toggle="dropdownNotification" class="relative inline-flex items-center text-sm font-medium text-center text-gray-500 " type="button">
                    ...
                    <div id="dropdownNotification" class="z-20 hidden w-full max-w-sm bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-800 dark:divide-gray-700" aria-labelledby="dropdownNotificationButton">
                        ...
                        <div class="divide-y divide-gray-100 dark:divide-gray-700">
                            ...
                            <div class="flex-shrink-0">
                                <img class="rounded-full w-11 h-11" src="https://i.pravatar.cc/300" alt="Jese image">
                            ...
                            <a href="#" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700">
                            <div class="flex-shrink-0">
                                <img class="rounded-full w-11 h-11" src="https://i.pravatar.cc/300" alt="Joseph image">
                            ...
                            <a href="#" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700">
                            <div class="flex-shrink-0">
                                <img class="rounded-full w-11 h-11" src="https://i.pravatar.cc/300" alt="Bonnie image">
                            ...
                            <a href="#" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700">
                            <div class="flex-shrink-0">
                                <img class="rounded-full w-11 h-11" src="https://i.pravatar.cc/300" alt="Leslie image">
                            ...
                            <a href="#" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700">
                            <div class="flex-shrink-0">
                                <img class="rounded-full w-11 h-11" src="https://i.pravatar.cc/300" alt="Robert image">
            ...
            <div class="px-3">
                ...
                <button id="dropdownAvatarNameButton" data-dropdown-toggle="dropdown-user" class="capitalize flex items-center text-md pe-1 font-medium text-1D4469 hover:text-blue-600 md:me-0 " type="button">
                        <span class="sr-only">Open user menu</span>
                        <img class="w-8 h-8 me-2 rounded-full" src="https://flowbite.com/docs/images/people/profile-picture-5.jpg" alt="user photo">
                        Hari Yadav
