        ...
        <div class="bg-F1F6F9 w-full font-poppins">
            ...
            <div class="flex flex-col bg-white p-4 ">
                <div class="flex justify-between items-center">
                    <h5 class=" text-203C50 font-['Be Vietnam'] text-32 font-medium ">New Company</h5>
                    <div class="relative">
            ...
            <section class="about bg-white mt-5 pt-5  py-20 ">
                ...
                <div class="gap-5 w-1/2 justify-around font-poppins flex-wrap flex grid grid-cols-2">
                    <div class=" ">
                    ...
                    <div>
            <label for="website" class="block mb-2 text-neutral-600 text-lg  font-medium  ">Website URL</label>
            <input type="url" id="website" class="border border-gray-300 text-gray-900 text-sm  focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " placeholder="" required />
        </div>

        <div class=" space-x-2">
            <div class="">
            <label for="types" class="mb-1 text-cyan-900 text-lg font-normal">Type</label>

            </div>
            <div id="types " class="p-2.5 ">
<button type="button" class="px-4 py-2   text-sm font-normal  border bg-white hover:bg-gray-300 focus:outline-none  option" data-option="business">Business</button>
<button type="button" class="px-4 py-2   text-sm font-normal  border bg-white hover:bg-gray-300 focus:outline-none  option" data-option="individual">Individual</button>
<button type="button" class="px-4 py-2   text-sm font-normal  border bg-white hover:bg-gray-300 focus:outline-none  option" data-option="prospect">Prospect</button>
</div>
</div>

        <div>
                        <label for="countries" class="block mb-1 text-neutral-600 text-lg font-normal  ">Business Category</label>
